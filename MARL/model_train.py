...
if __name__ == "__main__":
    ...
    register_env("bank", lambda _: BankSimEnv())
    ModelCatalog.register_custom_model("model1", CustomModel1)
    ModelCatalog.register_custom_model("model2", CustomModel2)
    obs_space = spaces.Box(np.array([-10, -10,  -10,  -10,  -10, -10]), -1*np.array([-10, -10,  -10,  -10,  -10,  -10]))
    act_space = spaces.Box(np.array([0, 0]), np.array([1, 1]))
